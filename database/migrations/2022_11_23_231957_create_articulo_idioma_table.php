...
class CreateArticuloIdiomaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('articulo_idioma', function (Blueprint $table) {
            $table->integer('id', true);
            $table->string('platillo', 100)->nullable()->default('');
            $table->string('nombre')->nullable()->default('');
            $table->string('descripcion', 500)->nullable()->default('');
            $table->string('simbologia', 1000)->nullable()->default('');
    ...
    {
        Schema::dropIfExists('articulo_idioma');
    }
}
