...
class CreateArticuloMedidaIdiomaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('articulo_medida_idioma', function (Blueprint $table) {
            ...
            $table->integer('id_articulo_medida');
            $table->integer('id_idioma');
            $table->integer('precio_tezontle');
        });
    }
    ...
    {
        Schema::dropIfExists('articulo_medida_idioma');
    }
}
